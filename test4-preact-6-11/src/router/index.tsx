...
const Test12 = lazy(() => import('../pages/test12'));
const Test13 = lazy(() => import('../pages/test13'));
const Test14 = lazy(() => import('../pages/test14'));
const Test15 = lazy(() => import('../pages/test15'));
const Test16 = lazy(() => import('../pages/test16'));
...
export default function Router() {
  const router: RouteObject[] = [
    ...
    {
      path: '/test11',
      element: lazyLoad(<Test11></Test11>),
    },
    {
      path: '/test12',
      element: lazyLoad(<Test12></Test12>),
    },
    {
      path: '/test13',
      element: lazyLoad(<Test13></Test13>),
    },
    {
      path: '/test14',
      element: lazyLoad(<Test14></Test14>),
    },
    {
      path: '/test15',
      element: lazyLoad(<Test15></Test15>),
    },
    {
      path: '/test16',
      element: lazyLoad(<Test16></Test16>),
    },
    {
      path: '*',
