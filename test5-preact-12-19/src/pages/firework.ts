...
import startPointFragment from "../shader/startpoint/fragment";
import startPointVertex from "../shader/startpoint/vertex";
...
export default class Fireworks {
  ...
  constructor(color: string, to: any, from = { x: 0, y: 0, z: 0 }) {
    ...
    audioLoader.load(
      `../../public/audio/pow${Math.floor(Math.random() * 4) + 1}.ogg`,
      (buffer) => {
